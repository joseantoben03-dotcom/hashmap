...
import { computeHash, findEntry, type Buckets } from '../../lib/hashmap';
import BucketWall from '../BucketWall';
import StepFooter from '../StepFooter';

interface Step5LookupDeleteProps {
  buckets: Buckets;
...
export default function Step5LookupDelete({ buckets, onDelete, onBack, onContinue }: Step5LookupDeleteProps) {
  const [query, setQuery] = useState('');
  const [result, setResult] = useState<ReturnType<typeof findEntry> | null>(null);
