...
import { BUCKET_COUNT, computeHash, totalEntries, type Buckets } from '../../lib/hashmap';
import BucketWall from '../BucketWall';
import HashWorking from '../HashWorking';
import StepFooter from '../StepFooter';

interface Step3InsertionProps {
  buckets: Buckets;
...
export default function Step3Insertion({ buckets, onInsert, onBack, onContinue }: Step3InsertionProps) {
  ...
  function file(k: string, v: string) {
